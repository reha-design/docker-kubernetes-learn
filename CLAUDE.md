...
- Commits use Conventional Commits with `docs:` type (this repo is documentation-only), message subject in English, and are pushed to `origin/master` on GitHub (`reha-design/docker-kubernetes-learn`, private).
